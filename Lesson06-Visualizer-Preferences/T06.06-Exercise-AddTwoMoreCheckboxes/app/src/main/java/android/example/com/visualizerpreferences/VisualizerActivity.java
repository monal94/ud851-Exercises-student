...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowMid(sharedPreferences.getBoolean("@string/pref_mid_key", getResources().getBoolean(R.bool.pref_show_mid_default)));
        mVisualizerView.setShowTreble(sharedPreferences.getBoolean("@string/pref_treble_key", getResources().getBoolean(R.bool.pref_show_treble_default)));
