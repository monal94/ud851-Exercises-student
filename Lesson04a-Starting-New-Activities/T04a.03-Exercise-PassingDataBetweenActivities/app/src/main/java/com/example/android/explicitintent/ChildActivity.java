...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent activityThatStarted = getIntent();
        // COMPLETED (4) Create an if statement to check if this Intent has the extra we passed from MainActivity
        if (activityThatStarted.hasExtra(Intent.EXTRA_TEXT)) {
            String textEntered = activityThatStarted.getStringExtra(Intent.EXTRA_TEXT);
